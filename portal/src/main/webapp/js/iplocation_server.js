...
function getBuyUrl(skuId){
    ...
    if(!count)count=1;
	if(pageConfig.product.isHYKHSP)return "http://eve.jd.com/.action?wid="+skuId+"&btype=30";
	if(pageConfig.product.isLOC){
...
//			var newUrl = "http://eve.jd.com/.action?wid="+pageConfig.product.skuid+"&btype=16&pid="+currentAreaInfo.currentProvinceId+"&cid="+currentAreaInfo.currentCityId;
