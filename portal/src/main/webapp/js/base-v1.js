 ...
 */
function login() {
    return location.href = "http://goshopping.com:8085/page/showLogin";
}
function regist() {
    return location.href = "http://goshopping.com:8085/page/register";
}
...
function search(a) {
    var b = "http://goshopping.com:80/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
